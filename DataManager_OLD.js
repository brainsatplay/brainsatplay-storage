...
export class DataManager {
    ...
    readyFNIRSDataForWriting = (from=0,to='end') => {
    ...
    autoSaveFNIRSChunk = (startidx = 0, to = 'end', deviceName = "heg", onsaved=this.listFiles, deviceAtlas) => {
